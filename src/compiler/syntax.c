...
{
       0,    55,    55,    60,    65,    70,    73,    77,    79,    81,
      87,    94,   101,   105,   112,   119,   121,   123,   125,   127,
     129,   131,   133
};
#endif
...
{
  "$end", "error", "$undefined", "tMAIN", "tPRINT", "tACCO", "tACCF",
  "tPARO", "tMOINS", "tPARF", "tSEP", "tPLUS", "tDIV", "tMUL", "tINT",
  "tCONST", "tEGAL", "tENDL", "tLITT", "tLITTEXP", "tID", "$accept", "S",
  "MAIN", "BODY", "INSTRS", "LINE", "PRINT", "DECL", "DECLKW", "ASSIGN",
  "EXPR", YY_NULLPTR
};
#endif
...
{
      -1,    -2,    17,   -17,    19,   -17,    24,    -4,    23,   -17,
     -17,    15,    26,   -17,    16,   -17,   -17,    18,   -17,    20,
      -6,   -17,    -4,    21,    25,    -6,   -17,   -17,   -17,    14,
     -17,    -6,   -17,    -5,    -6,    -6,    -6,    -6,    14,   -17,
      11,    11,    11,    11
};
...
{
       0,     0,     0,     2,     0,     1,     0,     6,     0,    12,
      13,     0,     0,     4,     0,     9,     8,     0,     7,     0,
       0,     3,     6,     0,     0,     0,    15,    17,    16,    14,
       5,     0,    10,     0,     0,     0,     0,     0,    11,    18,
      20,    19,    21,    22
};
...
{
       8,    25,     1,    34,    39,     4,    35,    36,    37,    33,
       9,    10,    26,    27,    28,    38,    11,     5,    40,    41,
      42,    43,    34,    36,    37,    35,    36,    37,     6,     7,
      19,    20,    21,    22,    32,    30,     0,    31,    23,     0,
      24
};

static const yytype_int8 yycheck[] =
{
       4,     7,     3,     8,     9,     7,    11,    12,    13,    25,
      14,    15,    18,    19,    20,    31,    20,     0,    34,    35,
      36,    37,     8,    12,    13,    11,    12,    13,     9,     5,
       7,    16,     6,    17,     9,    22,    -1,    16,    20,    -1,
      20
};
...
{
       0,     3,    22,    23,     7,     0,     9,     5,     4,    14,
      15,    20,    24,    25,    26,    27,    28,    29,    30,     7,
      16,     6,    17,    20,    20,     7,    18,    19,    20,    31,
      25,    16,     9,    31,     8,    11,    12,    13,    31,     9,
      31,    31,    31,    31
};
